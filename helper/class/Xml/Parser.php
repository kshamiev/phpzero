...
class Helper_Xml_Parser
{
    ...
    /**
     * Возвращает рабочий Helper_Xml_Object
     *
    ...
    /**
     * Устанавливает ранее обработанный Helper_Xml_Object
     *
     * @param Helper_Xml_Object $xml
     */
    public function Set_Xml(Helper_Xml_Object $xml)
    {
        $this->_Xml[0] = $xml;
    }
    ...
    private function _Node_Beg($fp_xml, $name, $attrs)
    {
        $this->_Level++;
        //  имя тега
        $this->_Xml[$this->_Level] = new Helper_Xml_Object($name);
        //  атрибуты
    ...
    /**
     * Парсер XML
     * Разбор XML файла и загрузка его в Xml объект (класс Helper_Xml_Object) свойства $this->_Xml
     ...
     * @param string $class_handler обработчик нод (по умолчанию класс Helper_Xml_Handler, для примера)
     * @return Helper_Xml_Object
     */
    ...
    private function _Save(Helper_Xml_Object $Xml_Object, $depth = 0)
    {
