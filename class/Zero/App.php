 ...
 * @todo В контроллерах доработать в проверках уникальность urn
 * @todo В проверках контроллеров добавить проверку существующий контролеров в ФС но отсутсвующих в БД
 */
class Zero_App
{
    /**
