...
insert  into `Zero_Groups`(`ID`,`Name`,`Status`,`Description`) values (1,'Developer','open','bbbb'),(2,'Guest','open',NULL),(3,'Users','open',NULL),(4,'Administrator','open',NULL);
...
insert  into `Zero_Users`(`ID`,`Zero_Groups_ID`,`Zero_Users_ID`,`Name`,`Login`,`Password`,`IsAccess`,`Email`,`Phone`,`Skype`,`IsCondition`,`ImgAvatar`,`IsOnline`,`DateOnline`,`Date`) values (1,1,NULL,'devaaaa','dev','e77989ed21758e78331b20e477fc5582','open','dev@domain.com','456',NULL,'no',NULL,'yes','2014-02-14 03:25:56','2013-05-01 00:00:00'),(2,4,NULL,'admin','admin','21232f297a57a5a743894a0e4a801fc3','open','admin@domain.com',NULL,NULL,'no','zero_users/100/100/100/100/100/100/100/100/100/100/2/services_imac.png','no','2013-05-29 17:41:43','2013-05-01 00:00:00');
