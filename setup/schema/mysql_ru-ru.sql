...
insert  into `Zero_Content`(`ID`,`Zero_Section_ID`,`Lang`,`Name`,`Title`,`Keywords`,`Description`,`Content`,`Block`) values (10,NULL,'ru-ru','Заголовок',NULL,NULL,NULL,'<p>Заголовок</p>','head'),(11,NULL,'ru-ru','Подвал',NULL,NULL,NULL,'<p>Подвал</p>','footer');
...
insert  into `Zero_Users`(`ID`,`Zero_Groups_ID`,`Zero_Users_ID`,`Name`,`Login`,`Password`,`IsAccess`,`Email`,`Phone`,`Skype`,`IsCondition`,`ImgAvatar`,`IsOnline`,`DateOnline`,`Date`,`Address`) values (1,1,NULL,'Разработчик','dev','e77989ed21758e78331b20e477fc5582','open','test@test.ru',NULL,NULL,'no',NULL,'yes','2014-10-21 19:08:59',NULL,NULL);
